...
public class ColaboradorController {
	...
	public ResponseEntity<Page<ColaboradorDTO>> findAll(Pageable pageable) {
		Page<ColaboradorDTO> dto = colaboradorService.findAll(pageable);
		return ResponseEntity.ok(dto);
	}
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ColaboradorDTO> update(@PathVariable Long id, @RequestBody ColaboradorDTO dto ) {
	    dto = colaboradorService.update(id, dto);
		return ResponseEntity.ok(dto);
	}
